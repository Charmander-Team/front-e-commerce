                           ...
                           <v-row>
                               ...
                               <v-col cols="12" lg="12" md="12"> 
                                   <v-card rounded="xl" class="mx-6" color="#ffffff">
                                        <v-card-title class="justify-center text-h4">Qui sommes nous ?</v-card-title>
                                        <v-card-text>
                                            Pokeshop est un site e-commerce proposant des cartes Pokémon à l'unité dont certaine sont de collections.<br>
                                            Cette plateforme à été réaliser par 4 étudiants d'une école digital de la région parisienne.<br>
                                            Antoine WITKOWSKI, Vincent BRÉCHAIRE, Christian AMBANG et Dino KAHTERAN.<br>
                                            Pour se faire ils ont créé une SAS au capital de 2000 euros en septembre 2020.<br>
                                            Riche d'une experience dans le developpement ils créent, maintiennent et administre eux même leur plateforme.<br>
                                            si vous souhaitez rejoindre une équipe dynamique et motivé n'hésitez pas une seconde et postulé via notre formulaire de contact.<br>
                                            bon shooping sur notre site et n'oublié pas :<br>
                                            Attrapés les tous.
                                        </v-card-text> 
                                        <v-card-text>
                                            Dénomination sociale: Pokeshop <br>
                                            Forme juridique: SAS<br>
                                            Adresse du siège social: 2 Place Pokemon Center 75012 Paris<br>
                                            Montant du capital social: 2000 €<br>
                                            Adresse mail: contact@pokeshop.fr<br> 
                                            Numéro de téléphone: 01 00 00 00 00<br>
...
Les présentes conditions générales de vente s'appliquent à toutes les ventes conclues sur le site Internet Pokeshop.

 

Le site Internet http://pokeshop.tk est un service de :

La société  Pokeshop
située 2 place pokemon center 75012 Paris, France
adresse URL du site : http://pokeshop.tk
e-mail : contact@pokeshop.fr
numéro de téléphone : 0100000000
Le site Internet Pokeshop commercialise les produits suivants : carte de jeu à collectionner.
...
Elles sont accessibles sur le site internet Pokeshop et prévaudront, le cas échéant, sur toute autre version ou tout autre document contradictoire.
...
Les présentes conditions générales de vente sont valables jusqu'au 01 septembre 2022.
...
Les présentes conditions générales ont pour objet de définir les droits et obligations des parties dans le cadre de la vente en ligne de biens proposés par le vendeur à l'acheteur, à partir du site internet Pokeshop.

Les présentes conditions ne concernent que les achats effectués sur le site de Pokeshop et livrés exclusivement en métropole ou en Corse. Pour toute livraison dans les DOM-TOM ou à l’étranger, il convient d'adresser un message à l’adresse e-mail suivante : contact@pokeshop.fr.

Ces achats concernent les produits suivants : carte de jeu à collectionner.
...
Pour toute question relative au suivi d'une commande, l'acheteur peut appeler le numéro de téléphone suivant : 0100000000 (coût d'un appel local), aux jours et horaires suivants : lundi au samedi, de 8h à 20h, ou envoyer un mail au vendeur à l’adresse mail suivante : contact@pokeshop.fr.
...
En cas d'utilisation frauduleuse de la carte bancaire, l'acheteur est invité, dès le constat de cette utilisation, à contacter le vendeur au numéro de téléphone suivant : 0100000000.
...
Pour les livraisons en France Métropolitaine et en Corse, le délai est de 7 jours à compter du jour suivant celui où l'acheteur a passé sa commande, selon les modalités suivantes : Colissimo. Au plus tard, le délai sera de 30 jours ouvrables après la conclusion du contrat.
...
- par téléphone au numéro suivant : 01 02 00 00 00 ;

- par e-mail à l'adresse suivante : reclamation@pokeshop.fr.
...
En cas d'erreur de livraison ou d'échange, tout produit à échanger ou à rembourser devra être retourné au vendeur dans son ensemble et dans son emballage d'origine, en Colissimo Recommandé, à l'adresse suivante : 2 place pokemon center, 75012 Paris.
...
Le traitement des informations communiquées par l'intermédiaire du site internet Pokeshop a fait l'objet d'une déclaration auprès de la CNIL.

L'acheteur dispose d'un droit d'accès permanent, de modification, de rectification et d'opposition s'agissant des informations le concernant. Ce droit peut être exercé dans les conditions et selon les modalités définies sur le site Pokeshop.
...
En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants, qu'ils peuvent exercer en faisant leur demande à l'adresse suivante : contact@pokeshop.fr.
...
Pokeshop<br>
<br>
située à : 2 place pokemon center, 75012 Paris<br>
<br>
n° de téléphone : 0100000000<br>
<br>
adresse mail : contact@pokeshop.fr<br>
<br><br>
 

Je vous notifie, par la présente, ma rétractation du contrat portant sur....................., commandée le :  .........<br>
<br>
