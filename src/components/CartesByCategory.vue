              ...
              <v-col
                ...
                >
                    ...
                    <v-card max-width="250" class="mt-3 pa-2">
                        ...
                        <v-btn @click="dialog = true, stock = item.stock, product = {id:item.id, img:item.image, ref:item.ref, price:item.price, name:item.name, quantite:null, montant:null, idContentOrder:null }" small color="deep-purple" dark v-if="item.stock>0">
                          Panier <sup>+</sup>
                        </v-btn>
